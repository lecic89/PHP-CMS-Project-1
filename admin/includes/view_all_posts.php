        ...
        foreach($_POST['checkBoxArray'] as $postValueId){
            ...
            switch($bulk_options){
                ...
                case 'published':
                    ...
                    $update_to_piblished_status = mysqli_query($connection, $query);

                    confirmQuery($update_to_piblished_status);
...
<form action="" method="post">
    <table class="table table-bordered table-hover">
        ...
        <div id="bulkOptionsContainer" class="col-xs-4" style="padding: 2% 2% 2% 0%" >
        ...
        <div class="col-xs-4" style="padding: 2% 2% 2% 0%">
        ...
        <tbody>
            ...
            <?php
                ...
                // $query  = "SELECT posts.post_id, posts.post_author, posts_post_user, posts.post_title, posts.post_category_id, posts.post_status, posts.post_image, ";
            ...
            ?>
                ...
                <?php
                    ...
                    echo "<td><img width='100' src='../images/$post_image' alt='image alt'></td>";
