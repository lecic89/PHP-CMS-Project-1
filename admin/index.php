    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- Admin pocetna dinamicki vizualni prikaz, analitika, podaci -->
                <div class="row">
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <!-- Refactored function.php/  function recordCount($table) -->
                ...
                <!-- refactored function.php  function checkStatus  -->
                <?php 
                    ...
                    // linija ca 192/  function checkUserRole($table, $column, $role)
